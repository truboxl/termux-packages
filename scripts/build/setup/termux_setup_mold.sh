...
termux_setup_mold() {
	...
	# maybe have this auto update together with package once license
	# issue settled otherwise keep this version
	local TERMUX_MOLD_VERSION=1.7.0
	local TERMUX_MOLD_TARFILE_SHA256=113f0db9915054f558a4e41cf6dbc45b7fd45076a4064830112fac8f82091fd9
