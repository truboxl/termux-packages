...
echo "This is a long compile test. Skipping."
exit

#pkg install -y emscripten-tests-third-party
pkg install -y cmake libxml2 libxslt ndk-sysroot openjdk-17 python-cryptography python-lxml python-numpy python-pip python-psutil python-ruff rust
