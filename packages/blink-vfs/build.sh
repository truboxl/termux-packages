...
TERMUX_PKG_DESCRIPTION="Tiny x86-64 Linux emulator with VFS"
...
termux_step_configure() {
	...
	export LDFLAGS+=" -lm"
	./configure --prefix="${TERMUX_PREFIX}" --enable-vfs
	...
	sed -i config.h -e "s|^#define DISABLE_VFS|// #define DISABLE_VFS|"
