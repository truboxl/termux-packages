...
TERMUX_PKG_DEPENDS="libiconv, libuv, luv, libmsgpack, libandroid-support, libvterm (>= 1:0.3-0), libluajit, libunibilium, libtreesitter, lua-lpeg"
...
termux_step_pre_configure() {
	...
	TERMUX_PKG_EXTRA_CONFIGURE_ARGS+=" -DLUA_PRG=${TERMUX_PKG_SRCDIR}/.deps/usr/bin/luajit"
}
