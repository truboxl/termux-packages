...
# Utility function for setting up mold linker.
# shellcheck source=scripts/build/setup/termux_setup_mold.sh
source "$TERMUX_SCRIPTDIR/scripts/build/setup/termux_setup_mold.sh"
