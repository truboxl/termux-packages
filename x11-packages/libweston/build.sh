...
TERMUX_PKG_DEPENDS="fontconfig, glib, libcairo, libdrm, libevdev, libglvnd, liblcms2, libpixman, libpng, libseat, libudev-zero, libwayland, libwebp, libxcb, libxkbcommon, opengl, pango"
