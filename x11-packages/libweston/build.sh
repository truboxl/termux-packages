...
TERMUX_PKG_DEPENDS="fontconfig, freerdp, glib, libcairo, libdrm, libevdev, libglvnd, liblcms2, libpixman, libpng, libseat, libudev-zero, libwayland, libwebp, libxcb, libxkbcommon, mesa, pango"
