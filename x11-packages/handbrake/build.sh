...
TERMUX_PKG_DEPENDS="ffmpeg, gdk-pixbuf, gst-plugins-base, gstreamer, gtk4, libass, libbluray, libcairo, libdav1d, libdvdnav, libdvdread, libiconv, libjansson, libjpeg-turbo, librsvg, libtheora, libvorbis, libvpx, libx264, libx265, libxml2, pango"
...
termux_step_pre_configure() {
	...
	sed -i -E "s|--cross-file=.+meson|--cross-file=$TERMUX_MESON_CROSSFILE|g" gtk/module.defs
